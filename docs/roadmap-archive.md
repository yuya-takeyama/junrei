# Junrei — Roadmap archive

Completed roadmap sections, moved verbatim from
[roadmap.md](./roadmap.md) on 2026-07-18 to keep the roadmap
forward-looking. Original order, status markers, and PR references are
preserved as they were at archive time.
